...
GMAC.data1  <- as.data.frame(sqlQuery(GMAC.data, "select Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='VE' and AreaScheme='1011'"), stringsAsFactors = FALSE)
...
#write.table(SACrestaAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/CrestaAllData.csv") 
...
write.table( upxmydata1,"//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/CrestaAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE)
...
#write.table(SARegionAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/RegionAllData.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/RegionAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(SAMunicipalityAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/MunicipalityAllData.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/MunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
RegionMunicipality.data4[,c(11,12)]<-0
...
#write.table(RegionMunicipalityAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/RegionMunicipality.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/RegionMunicipalitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(CrestaMunicipalityAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaMunicipalityAllData.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaMunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(CrestaMunicipalityCityAllData, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaMunicipalityCity.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaMunicipalityCitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(CityAlldata, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CityAlldata.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(CrestaCityAlldata, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaCityAlldata.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/CrestaCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
#write.table(MunicipalityCityAlldata, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/MunicipalityCityAlldata.data1.csv") 
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/MunicipalityCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
