...
GMAC.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   
                                      Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='CL' and remappedgeographysid is NULL and AreaScheme='1011'"), stringsAsFactors = FALSE)
...
write.table( upxmydata1,"//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/ChileLCrestaAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE)
upxmydata1new<-upxmydata1

#Regiondata
Region.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='CL'and remappedgeographysid is NULL  and AreaScheme='1052'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/ChileRegionAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata2new<-upxmydata1

#Municipality
Municipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='CL' and remappedgeographysid is NULL and AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileMunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 

#Region Municipality
RegionMunicipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='CL'  and AreaScheme='1053'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileRegionMunicipalitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata4new<-upxmydata1
#Cresta Municipality
CrestaMunicipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='CL' and remappedgeographysid is NULL and AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileCrestaMunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata5new<-upxmydata1

#Cresta Municipality City
CrestaMunicipalityCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CL' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                                        join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                                        where b.CountryCode='CL' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = FALSE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileCrestaMunicipalityCitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata6new<-upxmydata1

#City
City.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CL' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                      join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                      where b.CountryCode='CL' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata7new<-upxmydata1


#CrestaCity
CrestaCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CL' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                            join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                            where b.CountryCode='CL' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileCrestaCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata8new<-upxmydata1


#MunicipalityCity
MunicipalityCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CL' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                                  join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                                  where b.CountryCode='CL' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileMunicipalityCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ChileRegionCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
