...
GMAC.data1  <- as.data.frame(sqlQuery(GMAC.data, "select Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='PE' and AreaScheme='1011'"), stringsAsFactors = FALSE)
...
#Regiondata
Region.data1  <- as.data.frame(sqlQuery(GMAC.data, "select Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='PE' and AreaScheme='1054'"), stringsAsFactors = TRUE)
...
#Municipality
Municipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='PE' and AreaScheme='1073'"), stringsAsFactors = TRUE)
...
#Cresta Municipality
CrestaMunicipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='PE' and AreaScheme='1073'"), stringsAsFactors = TRUE)
...
CrestaMunicipalityCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "SELECT a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'PE' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                                        ...
                                                        where b.CountryCode='PE' and b.AreaScheme='1073'"), stringsAsFactors = FALSE)
...
City.data1  <- as.data.frame(sqlQuery(GMAC.data, "SELECT a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'PE' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                      join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                      where b.CountryCode='PE' and b.AreaScheme='1073'"), stringsAsFactors = TRUE)
