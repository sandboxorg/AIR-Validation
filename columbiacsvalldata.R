...
GMAC.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   
                                      Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,
                                      CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='EC' and 
                                      remappedgeographysid is NULL and AreaScheme='1011'"), stringsAsFactors = FALSE)
...
write.table( upxmydata1,"//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/ColLCrestaAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE)
upxmydata1new<-upxmydata1

#Regiondata
Region.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='EC'and remappedgeographysid is NULL  and AreaScheme='1012'"), stringsAsFactors = TRUE)
Region.data2<-Region.data1
Region.data1[, c(2,3)]<-''
Region.data2[, c(2,3,6:8)]<-''
Region.data2[, 1]<-1052
Region.data2[, 11]<- -19.530600  
Region.data2[, 12]<- -69.390701
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData/vencsvalldata/ColRegionAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata2new<-upxmydata1

#Municipality
Municipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='EC' and remappedgeographysid is NULL and AreaScheme='1071'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColMunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 

#Region Municipality
RegionMunicipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='EC'  and AreaScheme='1071'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColRegionMunicipalitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata4new<-upxmydata1
#Cresta Municipality
CrestaMunicipality.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   Areascheme,crestacode,Crestaname,AreaCode,AreaName,subareaCode,Subareaname,postalcode,countrycode,CountryName,latitude,longitude from AIRGeography..tGeography where CountryCode='EC' and remappedgeographysid is NULL and AreaScheme='1011'"), stringsAsFactors = TRUE)
CrestaMunicipality.data2<-CrestaMunicipality.data1
CrestaMunicipality.data2[, c(2,3)]<-'3'
...
CrestaMunicipality.data4[, c(2,3)]<-'3'
...
CrestaMunicipality.data5[,c(2,3)]<-'3'
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColCrestaMunicipalityAllDatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata5new<-upxmydata1

#Cresta Municipality City
CrestaMunicipalityCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CO' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                                        join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                                        where b.CountryCode='CO' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = FALSE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColCrestaMunicipalityCitylocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata6new<-upxmydata1

#City
City.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CO' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                      join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                      where b.CountryCode='CO' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata7new<-upxmydata1


#CrestaCity
CrestaCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CO' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                            join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                            where b.CountryCode='CO' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColCrestaCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata8new<-upxmydata1


#MunicipalityCity
MunicipalityCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select   a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CO' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                                  join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                                  where b.CountryCode='CO' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColMunicipalityCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
upxmydata9new<-upxmydata1

datachile<-rbind(upxmydata1new,upxmydata2new,upxmydata3new,upxmydata4new,upxmydata5new,upxmydata6new,upxmydata7new,upxmydata8new,upxmydata9new)
write.table(datachile, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/datachile.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 


#RegionCity
RegionCity.data1  <- as.data.frame(sqlQuery(GMAC.data, "select     a.strCityName,AreaScheme,CRESTACode,CRESTAName,AreaCode,AreaName,SubareaCode,SubareaName,PostalCode,'CO' as countrycode,CountryName,Latitude,Longitude  FROM [AIRGeography].[dbo].[tGeography] b 
                                            join [AIRGeography].[dbo].[TblAreaCity] a on a.guidExternal=b.GuidExternal
                                            where b.CountryCode='CO' and remappedgeographysid is NULL and b.AreaScheme='1072'"), stringsAsFactors = TRUE)
...
write.table(upxmydata1, "//qafile2/Leonardo/Feature Data/SouthAmerica/InputFiles/VenezuelaALLData//vencsvalldata/ColRegionCityAlldatalocation.csv", sep=",",quote=FALSE, row.names=FALSE,col.names=FALSE) 
